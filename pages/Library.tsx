...
const Library: React.FC = () => {
  ...
  const [actionLoading, setActionLoading] = useState<number | null>(null); // ID of book being acted on
  ...
  const handleBorrow = async (bookId: number) => {
    ...
    try {
      ...
      await loadBooks(); // Refresh counts
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingBook) {
        ...
        await MockBookService.add(formData as Omit<Book, 'id' | 'availableCopies'>);
              ...
              <div className="p-5 flex gap-4">
                ...
                <div className="flex-grow">
                  <div className="flex justify-between items-start">
                    <span className="text-xs font-semibold tracking-wide uppercase text-blue-600 mb-1 block">{book.category}</span>
            ...
            <form onSubmit={handleFormSubmit} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input required type="text" className="w-full rounded-lg border-slate-300 border px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none" value={formData.category} onChange={e => setFormData({...formData, category: e.target.value})} />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
